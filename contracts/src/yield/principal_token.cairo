// PrincipalToken (PT) — ERC20 representing the principal component of a yield position
// Redeemable 1:1 for the underlying slToken at or after maturity.
...
pub mod PrincipalToken {
    ...
    #[abi(embed_v0)]
    impl PrincipalTokenImpl of super::IPrincipalToken<ContractState> {
